...
| **Data Mapping Prototype** | `data_mapping_prototype/` | Static HTML walkthrough for mapping source data onto a stream/batch schema, with field-by-field guidance and a data-flow trace |
